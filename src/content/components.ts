export const categoryComponentsMap: Record<string, string[]> = {
  ...
  banana: ["produce", "farming", "packaging"],
  fruit: ["produce", "farming", "packaging"],
  fruits: ["produce", "farming", "packaging"],
  produce: ["produce", "farming", "packaging"],
  grocery: ["produce", "farming", "packaging"],
  food: ["produce", "farming", "packaging"],
